...
![HMM_slowman_image_1](https://img.l1uyun.top/HMM_slowman_image_1.png)

## ftp 匿名登录

![HMM_slowman_image_2](https://img.l1uyun.top/HMM_slowman_image_2.png)
...
假装枚举出来了
![HMM_slowman_image_3](https://img.l1uyun.top/HMM_slowman_image_3.png)
## 枚举 mysql 信息
```bash
sudo mysql -h 192.168.10.8 -u trainerjeff -psoccer1
```
![HMM_slowman_image_4](https://img.l1uyun.top/HMM_slowman_image_4.png)
```bash
|  1 | gonzalo     tH1sS2stH3g0nz4l0pAsSWW0rDD!! 
|  2 | $SECRETLOGINURL /secretLOGIN/login.html  
```
![HMM_slowman_image_5](https://img.l1uyun.top/HMM_slowman_image_5.png)
## web 枚举
![HMM_slowman_image_6](https://img.l1uyun.top/HMM_slowman_image_6.png)
进入之前 mysql 中发现的隐藏目录, 使用发现的用户名密码登录, 后面发现这个也能登录 ssh
![HMM_slowman_image_7](https://img.l1uyun.top/HMM_slowman_image_7.png)
进去之后有个压缩包, 有密码
使用 john
![HMM_slowman_image_8](https://img.l1uyun.top/HMM_slowman_image_8.png)
...
## USER_trainerjean
![HMM_slowman_image_9](https://img.l1uyun.top/HMM_slowman_image_9.png)
...
![HMM_slowman_image_10](https://img.l1uyun.top/HMM_slowman_image_10.png)
...
```
![HMM_slowman_image_11](https://img.l1uyun.top/HMM_slowman_image_11.png)
