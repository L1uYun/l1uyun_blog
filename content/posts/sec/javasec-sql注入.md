...
![](https://img.l1uyun.top/javasec-sql注入_image_1.png)
[JavaSec](https://github.com/bewhale/JavaSec)
![](https://img.l1uyun.top/javasec-sql注入_image_2.png)
## JDBC
JDBC有两个方法执行SQL语句，分别是PrepareStatement和Statement。
...
```
![](https://img.l1uyun.top/javasec-sql注入_image_3.png)
...
```
![](https://img.l1uyun.top/javasec-sql注入_image_4.png)
### JDBCTemplate
