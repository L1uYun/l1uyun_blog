...
```
![HMM_zon_image_1](https://img.l1uyun.top/HMM_zon_image_1.png)
...
![HMM_zon_image_2](https://img.l1uyun.top/HMM_zon_image_2.png)

![HMM_zon_image_3](https://img.l1uyun.top/HMM_zon_image_3.png)

## 利用空格绕过文件上传过滤
![HMM_zon_image_4](https://img.l1uyun.top/HMM_zon_image_4.png)

测试之后是检查文件名, 而不是文件头, 而且图片马不能正常解析
![HMM_zon_image_5|750](https://img.l1uyun.top/HMM_zon_image_5.png)
- 非 jpeg 格式的无法上传
![HMM_zon_image_6](https://img.l1uyun.top/HMM_zon_image_6.png)

- jpeg 格式能够正常上传
![HMM_zon_image_7](https://img.l1uyun.top/HMM_zon_image_7.png)
![HMM_zon_image_8](https://img.l1uyun.top/HMM_zon_image_8.png)
...
"webshell.jpeg .php"
```
![HMM_zon_image_9](https://img.l1uyun.top/HMM_zon_image_9.png)


一句话木马, 获得 webshell
![HMM_zon_image_10](https://img.l1uyun.top/HMM_zon_image_10.png)
freddie
## webshell
上传一个反向 shell
```bash
...
```
![HMM_zon_image_11|650](https://img.l1uyun.top/HMM_zon_image_11.png)
...
![HMM_zon_image_12](https://img.l1uyun.top/HMM_zon_image_12.png)
## user. txt PWD
```bash
Freddie  | LDVK@dYiEa2I1lnjrEeoMif 
```
![HMM_zon_image_13](https://img.l1uyun.top/HMM_zon_image_13.png)
```bash
...
用 GPT 梳理一下逻辑
![HMM_zon_image_14|850](https://img.l1uyun.top/HMM_zon_image_14.png)

![HMM_zon_image_15|650](https://img.l1uyun.top/HMM_zon_image_15.png)
![HMM_zon_image_16|423](https://img.l1uyun.top/HMM_zon_image_16.png)
![HMM_zon_image_17|700](https://img.l1uyun.top/HMM_zon_image_17.png)