...
![](https://img.l1uyun.top/红日靶场1-win域_image_1.png)

根据这个网络拓扑图,win7机器有两个网卡,是通外网的,win2003和win2008是在内网环境中

![](https://img.l1uyun.top/红日靶场1-win域_image_2.png)

先给win7添加一下网卡,这里我习惯使用桥接,所以另一个网卡是桥接模式

![](https://img.l1uyun.top/红日靶场1-win域_image_3.png)

然后再为另外两台机器设置only-host模式,并在网络编辑器中将这个模式的网段修改为192.168.53.0/24

![](https://img.l1uyun.top/红日靶场1-win域_image_4.png)


最后进入win7机器,进去之后要改默认密码(hongrisec@2019),改成了l1uyun@2024,启动web服务器.

![|536](https://img.l1uyun.top/红日靶场1-win域_image_5.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_6.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_7.png)

这里的secure_file_priv=NULL,不允许导入导出,所以不能直接写入shell

![](https://img.l1uyun.top/红日靶场1-win域_image_8.png)

再尝试一下通过日志Getshell的方法

SHOW VARIABLES LIKE '%general_log%'

![](https://img.l1uyun.top/红日靶场1-win域_image_9.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_10.png)

使用蚁剑连接,拿到shell

![](https://img.l1uyun.top/红日靶场1-win域_image_11.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_12.png)

这都不用搜索了,前台模板这个位置大概率能执行php代码

![](https://img.l1uyun.top/红日靶场1-win域_image_13.png)

找到这个layout.php,这个文件是每个页面都需要包含的,所以在这里写入webshell

![](https://img.l1uyun.top/红日靶场1-win域_image_14.png)

可以连接

![](https://img.l1uyun.top/红日靶场1-win域_image_15.png)

这个cms里面也有sql执行,就不看了
## 内网渗透
### 信息收集

![](https://img.l1uyun.top/红日靶场1-win域_image_16.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_17.png)

发现有内网网段

![](https://img.l1uyun.top/红日靶场1-win域_image_18.png)

查看域用户

![](https://img.l1uyun.top/红日靶场1-win域_image_19.png)

查看域管理员信息

![](https://img.l1uyun.top/红日靶场1-win域_image_20.png)

整理一下收集到的win域信息

该域名为god.org，域控为OWA，域管理员为Administrator，内网网段为192.168.52.1/24，我们用ping命令探测域控的ip

![](https://img.l1uyun.top/红日靶场1-win域_image_21.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_22.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_23.png)

成功rdp上去了

![](https://img.l1uyun.top/红日靶场1-win域_image_24.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_25.png)
### getsystem提权
提权,使用meterpreter里面的getsystem一键提权
![](https://img.l1uyun.top/红日靶场1-win域_image_26.png)
### 迁移进程
使用ps查看进程信息,msf的进程pid为5060,apache的为2860,进行进程迁移

![](https://img.l1uyun.top/红日靶场1-win域_image_27.png)

迁移,然后清除痕迹

![](https://img.l1uyun.top/红日靶场1-win域_image_28.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_29.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_30.png)

获取到明文凭证
![](https://img.l1uyun.top/红日靶场1-win域_image_31.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_32.png)

使用auxiliary/server/socks_proxy模块来实现socks

先background把现在的meterpreter会话挂起,然后加载这个模块

![](https://img.l1uyun.top/红日靶场1-win域_image_33.png)
查看jobs可以看到后台运行的socks进程

![](https://img.l1uyun.top/红日靶场1-win域_image_34.png)
...
![](https://img.l1uyun.top/红日靶场1-win域_image_35.png)

那就添加一个用户,然后rdp上去算了
先添加一个用户

![](https://img.l1uyun.top/红日靶场1-win域_image_36.png)

查看添加的用户,添加成功

![](https://img.l1uyun.top/红日靶场1-win域_image_37.png)
...
```
![](https://img.l1uyun.top/红日靶场1-win域_image_38.png)

3389是关闭的,尝试开启3389

![](https://img.l1uyun.top/红日靶场1-win域_image_39.png)

这边是显示已经开启了的,但是还是连不上去

![](https://img.l1uyun.top/红日靶场1-win域_image_40.png)

原来是防火墙没关
```bash
set COMMAND  'netsh advfirewall set allprofiles state off'
```
![](https://img.l1uyun.top/红日靶场1-win域_image_41.png)

这里为啥凭据会是错误的....我在虚拟机界面是可以使用这个凭据登进去的...

![](https://img.l1uyun.top/红日靶场1-win域_image_42.png)


### cs上线
看了不少wp都是用cs拿的域控
![](https://img.l1uyun.top/红日靶场1-win域_image_43.png)
另一边连接cs_server
![](https://img.l1uyun.top/红日靶场1-win域_image_44.png)
启动监听器
![](https://img.l1uyun.top/红日靶场1-win域_image_45.png)
生成payload
![](https://img.l1uyun.top/红日靶场1-win域_image_46.png)
然后在蚁剑上上传进去,并执行,这边很快的显示弹回来了
![](https://img.l1uyun.top/红日靶场1-win域_image_47.png)
之后再beacon进行交互
```bash
sleep 0  # 进入交互模式
getsystem # 提权
...
![](https://img.l1uyun.top/红日靶场1-win域_image_48.png)
然后右键,选择psexec64
![](https://img.l1uyun.top/红日靶场1-win域_image_49.png)
新建一个用于psexec的监听器,然后
![](https://img.l1uyun.top/红日靶场1-win域_image_50.png)
运行之后就能拿到shell了,换成cs之后,很容易的就拿到了域控的shell
![](https://img.l1uyun.top/红日靶场1-win域_image_51.png)

最后以同样的方法,使用psexec32上线win2003机器
![](https://img.l1uyun.top/红日靶场1-win域_image_52.png)
