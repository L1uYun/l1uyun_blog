...
访问192.168.3.3
### 信息收集
![](https://img.l1uyun.top/红日靶场3_image_1.png)
joomla cms
![](https://img.l1uyun.top/红日靶场3_image_2.png)
这个cms之前打靶机的时候遇见过
![](https://img.l1uyun.top/红日靶场3_image_3.png)
在README.txt中发现了版本信息(在http://192.168.3.3/administrator/manifests/files/joomla.xml中也有)
![](https://img.l1uyun.top/红日靶场3_image_4.png)
...
回到目录扫描
御剑扫一下
![](https://img.l1uyun.top/红日靶场3_image_5.png)
phpinfo
![](https://img.l1uyun.top/红日靶场3_image_6.png)
...
```
navicat连一下
![](https://img.l1uyun.top/红日靶场3_image_7.png)
```bash
admin
...
![](https://img.l1uyun.top/红日靶场3_image_8.png)
### 后台模板getshell
上传webshell,这里生成的是蚁剑的
![|500](https://img.l1uyun.top/红日靶场3_image_9.png)
修改error.php,并保存
![](https://img.l1uyun.top/红日靶场3_image_10.png)
路径是`http://192.168.3.3/templates/beez3/error.php`
### antsword
连上去了
![](https://img.l1uyun.top/红日靶场3_image_11.png)
加载插件之后执行命令
![](https://img.l1uyun.top/红日靶场3_image_12.png)
...
尝试一下脏牛
![](https://img.l1uyun.top/红日靶场3_image_13.png)
...
![](https://img.l1uyun.top/红日靶场3_image_14.png)
...
![](https://img.l1uyun.top/红日靶场3_image_15.png)
linux的两台机器拿到了
![](https://img.l1uyun.top/红日靶场3_image_16.png)
还剩下三台win机器
```bash
192.168.93.10
192.168.93.20
...
```
![](https://img.l1uyun.top/红日靶场3_image_17.png)
附上其他师傅的横向思路
```bash
...
![](https://img.l1uyun.top/红日靶场3_image_18.png)

发现还有不少东西要学,win和linux的免杀,win域渗透,权限维持....我还要继续学下去吗,已经沉没的比较多了
![](https://img.l1uyun.top/红日靶场3_image_19.png)

最后偷一张拓扑图
![](https://img.l1uyun.top/红日靶场3_image_20.png)
