...
## 搭建环境
![](https://img.l1uyun.top/红日靶场2_win域_image_1.png)
```
administrator
1qaz@WSX
默认密码都是1qaz@WSX
...
创建一个vmnet2
![](https://img.l1uyun.top/红日靶场2_win域_image_2.png)

然后把三台机器的网卡2都改成这个vmnet2就行了
![](https://img.l1uyun.top/红日靶场2_win域_image_3.png)
DC机器不需要做什么处理,改完网卡直接启动就行

这里的另外一个网卡,作者设置的是111网段,但是我习惯了自己的ip,所以选择改pc和web两台机器里面的ip

先改一下pc这台机器,这台先改下ip
![](https://img.l1uyun.top/红日靶场2_win域_image_4.png)
再测试一下连通性,使用外部的parrot机器ping一下,没通,需要关闭防火墙
![](https://img.l1uyun.top/红日靶场2_win域_image_5.png)
...
![](https://img.l1uyun.top/红日靶场2_win域_image_6.png)
进去之后直接注销掉,切换成域用户mssql,密码还是1qaz@WSX

然后还是先改ip
![](https://img.l1uyun.top/红日靶场2_win域_image_7.png)

改完之后测试一下两个网段都能不能ping通

ping不通的话得关一下web的防火墙,关掉之后就能ping通了
![](https://img.l1uyun.top/红日靶场2_win域_image_8.png)
...
![](https://img.l1uyun.top/红日靶场2_win域_image_9.png)
以管理员身份启动一下weblogic
![](https://img.l1uyun.top/红日靶场2_win域_image_10.png)
...
![](https://img.l1uyun.top/红日靶场2_win域_image_11.png)
...
CVE-2016-0638
![](https://img.l1uyun.top/红日靶场2_win域_image_12.png)

![](https://img.l1uyun.top/红日靶场2_win域_image_13.png)

### antsword_内存马
使用这个工具里面的内存马,上传antsword_Custom_Filter内存马

![|650](https://img.l1uyun.top/红日靶场2_win域_image_14.png)

进去之后查看ip,是存在内网环境的
![](https://img.l1uyun.top/红日靶场2_win域_image_15.png)

## 内网
这里还有一台PC机器是暴露在外网环境中的,但是已经拿了web机器的shell,就先进内网
### 信息收集
局域网机器
![](https://img.l1uyun.top/红日靶场2_win域_image_16.png)
本机信息
![](https://img.l1uyun.top/红日靶场2_win域_image_17.png)
无法查看域用户
![](https://img.l1uyun.top/红日靶场2_win域_image_18.png)
本地管理员组,这里面有域用户DE1AY\Domain Admins这个域用户
![](https://img.l1uyun.top/红日靶场2_win域_image_19.png)
域信息
![](https://img.l1uyun.top/红日靶场2_win域_image_20.png)
...
```
![](https://img.l1uyun.top/红日靶场2_win域_image_21.png)
创建payload
![](https://img.l1uyun.top/红日靶场2_win域_image_22.png)
上传马子,将shell传到cs上
![](https://img.l1uyun.top/红日靶场2_win域_image_23.png)

获取明文凭据
![](https://img.l1uyun.top/红日靶场2_win域_image_24.png)

rdp也能连上去
![](https://img.l1uyun.top/红日靶场2_win域_image_25.png)
噢,简称和完整域名的区别
![](https://img.l1uyun.top/红日靶场2_win域_image_26.png)
###  CS后渗透_横向移动
上线cs之后,使用cs上面的横向移动模块中psexec就能解决掉剩下的两台机器了

域控
![](https://img.l1uyun.top/红日靶场2_win域_image_27.png)

PC机器
![](https://img.l1uyun.top/红日靶场2_win域_image_28.png)
